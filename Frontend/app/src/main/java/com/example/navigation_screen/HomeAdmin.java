...
public class HomeAdmin extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(HomeAdmin.this, android.R.layout.simple_spinner_item, courseNames);
    ...
    private void loadCourseReviews(int courseId) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        try {
                            ...
                            for (int i = 0; i < reviews.length(); i++) {
                                ...
                                fetchUsername(userId, username -> {
                                    ...
                                    TextView reviewView = new TextView(HomeAdmin.this);
                                    ...
                                    HomeAdmin.this.runOnUiThread(() -> reviewsLayout.addView(reviewView));
                                });
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // Handle error
                        Toast.makeText(HomeAdmin.this, "Error fetching reviews: " + error.toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void fetchUsername(int userId, Consumer<String> callback) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                error -> {
                    Toast.makeText(HomeAdmin.this, "Error fetching username: " + error.toString(), Toast.LENGTH_LONG).show();
